...
plot(mod_sim_patient_visit)

gelman.diag(mod_sim_patient_visit)
autocorr.diag(mod_sim_patient_visit)
autocorr.plot(mod_sim_patient_visit)
effectiveSize(mod_sim_patient_visit)
